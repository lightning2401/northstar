		                                    ...
		                                    if (levelchunksection != null) {
		                                    	...
		                                    	BlockState blockstate = levelchunksection.getBlockState(i3, j3, k3);
		                                          ...
		                                          for(OreConfiguration.TargetBlockState oreconfiguration$targetblockstate : pConfig.targetStates) {
		                                             if (OreFeature.canPlaceOre(blockstate, bulksectionaccess::getBlockState, pRandom, pConfig, oreconfiguration$targetblockstate, blockpos$mutableblockpos)) {
		                                                levelchunksection.setBlockState(i3, j3, k3, oreconfiguration$targetblockstate.state, false);
		                                                this.markAboveForPostProcessing(pLevel, blockpos$mutableblockpos.below());
		                                                ++i;
		                                                break;
		                                             }
		                                          }
