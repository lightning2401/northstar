...
public class StoneColumnConfiguration implements FeatureConfiguration  {
	public static final Codec<StoneColumnConfiguration> CODEC = RecordCodecBuilder.create((p_160784_) -> {
		 return p_160784_.group(Codec.intRange(1, 512).fieldOf("floor_to_ceiling_search_range").orElse(30).forGetter((p_160984_) -> {
		  ...
		  })).apply(p_160784_, StoneColumnConfiguration::new);
	   });
