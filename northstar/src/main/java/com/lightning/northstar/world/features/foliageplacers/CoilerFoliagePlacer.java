...
public class CoilerFoliagePlacer extends FoliagePlacer {
   ...
   @Override
   protected void createFoliage(LevelSimulatedReader level, FoliageSetter blocksetter, RandomSource pRandom, TreeConfiguration pConfig, int int1, FoliagePlacer.FoliageAttachment foliage, int int2, int int3, int int4) {
