...
public class NorthstarItems {
	...
	public static final RegistryObject<Item> RAW_MARTIAN_IRON_ORE = ITEMS.register("raw_martian_iron_ore", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> RAW_TUNGSTEN_ORE = ITEMS.register("raw_tungsten_ore", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> CRUSHED_RAW_TUNGSTEN = ITEMS.register("crushed_raw_tungsten", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> TUNGSTEN_NUGGET = ITEMS.register("tungsten_nugget", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> RAW_GLOWSTONE_ORE = ITEMS.register("raw_glowstone_ore", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> ENRICHED_GLOWSTONE_ORE = ITEMS.register("enriched_glowstone_ore", () -> new Item(new Item.Properties()));
	
	public static final RegistryObject<Item> MARTIAN_STEEL = ITEMS.register("martian_steel", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> MARTIAN_STEEL_SHEET = ITEMS.register("martian_steel_sheet", () -> new Item(new Item.Properties()));
	...
	public static final RegistryObject<Item> DORMANT_MARTIAN_SAPLING = ITEMS.register("dormant_martian_sapling", () -> new Item(new Item.Properties()));
	...
	public static final RegistryObject<Item> DORMANT_MARTIAN_SEED = ITEMS.register("dormant_martian_seed", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> MARTIAN_SWORD = ITEMS.register("martian_sword",() -> new SwordItem(NorthstarToolTiers.MARTIAN_STEEL, 3, -2.4f,new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> MARTIAN_PICKAXE = ITEMS.register("martian_pickaxe",() -> new PickaxeItem(NorthstarToolTiers.MARTIAN_STEEL, 1, -2.8f,new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> MARTIAN_SHOVEL = ITEMS.register("martian_shovel",() -> new ShovelItem(NorthstarToolTiers.MARTIAN_STEEL, 1.5f, -3.0f,new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> MARTIAN_AXE = ITEMS.register("martian_axe",() -> new AxeItem(NorthstarToolTiers.MARTIAN_STEEL, 5, -3.0f,new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> MARTIAN_HOE = ITEMS.register("martian_hoe",() -> new HoeItem(NorthstarToolTiers.MARTIAN_STEEL, -2, 0.0f,new Item.Properties().stacksTo(1)));
    
    public static final RegistryObject<Item> MARTIAN_STEEL_HELMET = ITEMS.register("martian_steel_helmet",() -> new ArmorItem(NorthstarArmorTiers.MARTIAN_STEEL_ARMOR, ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> MARTIAN_STEEL_CHESTPLATE = ITEMS.register("martian_steel_chestplate",() -> new ArmorItem(NorthstarArmorTiers.MARTIAN_STEEL_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> MARTIAN_STEEL_LEGGINGS = ITEMS.register("martian_steel_leggings",() -> new ArmorItem(NorthstarArmorTiers.MARTIAN_STEEL_ARMOR, ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> MARTIAN_STEEL_BOOTS = ITEMS.register("martian_steel_boots",() -> new ArmorItem(NorthstarArmorTiers.MARTIAN_STEEL_ARMOR, ArmorItem.Type.BOOTS, new Item.Properties()));
    ...
    public static final RegistryObject<MartianSteelSpaceSuitArmorItem> MARTIAN_STEEL_SPACE_SUIT_HELMET = ITEMS.register("martian_steel_space_suit_helmet",() -> new MartianSteelSpaceSuitArmorItem(NorthstarArmorTiers.MARTIAN_STEEL_SPACE_SUIT, ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<MartianSteelSpaceSuitArmorItem> MARTIAN_STEEL_SPACE_SUIT_CHESTPIECE = ITEMS.register("martian_steel_space_suit_chestpiece",() -> new MartianSteelSpaceSuitArmorItem(NorthstarArmorTiers.MARTIAN_STEEL_SPACE_SUIT, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<MartianSteelSpaceSuitArmorItem> MARTIAN_STEEL_SPACE_SUIT_LEGGINGS = ITEMS.register("martian_steel_space_suit_leggings",() -> new MartianSteelSpaceSuitArmorItem(NorthstarArmorTiers.MARTIAN_STEEL_SPACE_SUIT, ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<MartianSteelSpaceSuitArmorItem> MARTIAN_STEEL_SPACE_SUIT_BOOTS = ITEMS.register("martian_steel_space_suit_boots",() -> new MartianSteelSpaceSuitArmorItem(NorthstarArmorTiers.MARTIAN_STEEL_SPACE_SUIT, ArmorItem.Type.BOOTS, new Item.Properties()));
    ...
    public static final RegistryObject<ForgeSpawnEggItem> MERCURY_TORTOISE_SPAWN_EGG = ITEMS.register("mercury_tortoise_spawn_egg",
            () -> new ForgeSpawnEggItem(NorthstarEntityTypes.MERCURY_TORTOISE, 0x877b81, 0x6b5b64, new Item.Properties()));
    ...
    public static final RegistryObject<MartianFlowerItem> MARS_TULIP_FLOWER = ITEMS.register("mars_tulip_flower",() -> new MartianFlowerItem(NorthstarBlocks.MARS_TULIP.get(), new Item.Properties()));
    public static final RegistryObject<MartianFlowerItem> MARS_PALM_FLOWER = ITEMS.register("mars_palm_flower",() -> new MartianFlowerItem(NorthstarBlocks.MARS_PALM.get(), new Item.Properties()));
    public static final RegistryObject<MartianFlowerItem> MARS_SPROUT_FLOWER = ITEMS.register("mars_sprout_flower",() -> new MartianFlowerItem(NorthstarBlocks.MARS_SPROUT.get(), new Item.Properties()));
    
    //ice cream  :]
	@SuppressWarnings("deprecation")
	public static final RegistryObject<Item> VANILLA_ICE_CREAM = ITEMS.register("vanilla_ice_cream", () -> new Item(new Item.Properties()
			.food((new FoodProperties.Builder()).nutrition(6).saturationMod(0.7F).build())));
	@SuppressWarnings("deprecation")
	public static final RegistryObject<Item> CHOCOLATE_ICE_CREAM = ITEMS.register("chocolate_ice_cream", () -> new Item(new Item.Properties()
	...
	public static final RegistryObject<Item> FLATTENED_DOUGH = ITEMS.register("flattened_dough", () -> new Item(new Item.Properties()));
	
	public static final RegistryObject<Item> RAW_ICE_CREAM_CONE = ITEMS.register("raw_ice_cream_cone", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> ICE_CREAM_CONE = ITEMS.register("ice_cream_cone", () -> new Item(new Item.Properties().food(Foods.MELON_SLICE)));

	
	public static final RegistryObject<Item> MARTIAN_STRAWBERRY = ITEMS.register("martian_strawberry", () -> new SeedItem(NorthstarBlocks.MARTIAN_STRAWBERRY_BUSH.get(), new Item.Properties().food(Foods.APPLE)));
	...
	public static final RegistryObject<Item> LUNAR_SAPPHIRE_SHARD = ITEMS.register("lunar_sapphire_shard", () -> new Item(new Item.Properties()));
	
	public static final RegistryObject<Item> POLISHED_LUNAR_SAPPHIRE = ITEMS.register("polished_lunar_sapphire", () -> new Item(new Item.Properties()));
	...
	public static final RegistryObject<Item> TARGETING_COMPUTER = ITEMS.register("targeting_computer", () -> new Item(new Item.Properties().stacksTo(1)));
	...
	public static final RegistryObject<Item> CIRCUIT = ITEMS.register("circuit", () -> new Item(new Item.Properties()));
