...
public class MarsCobraRenderer extends GeoEntityRenderer<MarsCobraEntity> {
	...
	@Override
	public RenderType getRenderType(MarsCobraEntity animatable, float partialTick, PoseStack poseStack,
	...
	@Override
	public void render(GeoModel model, MarsCobraEntity animatable, float partialTick, RenderType type,
