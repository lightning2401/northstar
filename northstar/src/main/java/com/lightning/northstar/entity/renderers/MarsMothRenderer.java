...
public class MarsMothRenderer extends GeoEntityRenderer<MarsMothEntity> {
	...
	@Override
	public RenderType getRenderType(MarsMothEntity animatable, float partialTick, PoseStack poseStack,
	...
	@Override
	public void render(GeoModel model, MarsMothEntity animatable, float partialTick, RenderType type,
